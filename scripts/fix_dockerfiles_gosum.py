...
# Template with BuildKit cache mounts and OPTIONAL go.sum (glob pattern)
...
COPY services/{service_name}/go.mod services/{service_name}/go.su[m] ./services/{service_name}/
